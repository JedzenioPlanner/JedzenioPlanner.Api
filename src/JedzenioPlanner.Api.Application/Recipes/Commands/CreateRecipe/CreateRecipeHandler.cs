...
{
    public class CreateRecipeHandler : IRequestHandler<CreateRecipe, Guid>
    {
        ...
        public CreateRecipeHandler(IEventStore<Recipe> eventStore, RecipeEventsMapper mapper, ICurrentUserService currentUser, IDateTimeService dateTime)
        {
